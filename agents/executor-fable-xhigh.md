...
description: Top-tier ticket executor at x-high reasoning effort, for irreversible, run-wide or adversarial work where deriving the invariant, correctness argument or core design is itself the task. Used by /orchestrate for tickets labelled executor:fable effort:xhigh.
model: fable
effort: xhigh
---
